...
from mqtt_spb_wrapper import MetricDataType, MqttSpbEntityDevice, MqttSpbEntityNode

_DEBUG = True  # Enable debug messages

# MQTT Broker parameters
_MQTT_HOST = "172.16.1.10"
_MQTT_PORT = 1885
_MQTT_USER = ""
_MQTT_PASSW = ""
...
for i in range(5):
    ...
    ds={
        "Temperature": [value + 24.5, 22.0, 21.8],
        "Humidity": [value + 60.3, 58.9, 59.5],
        "Status": ["Normal", "Normal", "Normal"]
    }
    device.data.set_value("dataset", ds)

    pos={
        "Reference": [25+value],
        "Actual": [30+value],
    }
    device.data.set_value("position",pos)
